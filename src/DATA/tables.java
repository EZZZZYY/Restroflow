...
//            dbop.setDataorDelete(placeorder, "PLACE ORDER TABLE CREATED");
            String userSetting = "CREATE TABLE userSetting ("+ "id INT AUTO_INCREMENT PRIMARY KEY,"+ "organisation_name VARCHAR(255),"+ "security_question VARCHAR(255),"+ "answer VARCHAR(255)"+ ")";
            dbop.setDataorDelete(userSetting, "UserSetting Table Created");
        } catch (Exception e) {
